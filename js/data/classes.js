...
export const CLASSES = {
  ...
  hunter: {
    ...
    soloBonus: 0.238,
    soloHp: 0.25,
    companion: { name: 'Wolf', color: '#8a8f98', hpMult: 0.62, apMult: 0.24, swingTime: 2.1, armorMult: 0.55 },
    abilities: [
  ...
  priest: {
    ...
    soloBonus: 0.302,
    soloHp: 0.30,
    companion: { name: 'Mercenary', color: '#9a7b4f', hpMult: 0.85, apMult: 0.42, swingTime: 2.4, armorMult: 0.9 },
    abilities: [
  ...
  warlock: {
    ...
    soloBonus: 0.202,
    soloHp: 0.25,
    companion: { name: 'Imp', color: '#b0453f', hpMult: 0.52, apMult: 0.23, swingTime: 1.9, armorMult: 0.45 },
    abilities: [
      ...
      { id: 'soulfire', type: 'fire', name: 'Soul Fire', unlock: 20, cd: 16, kind: 'nuke', school: SCHOOL.MAGIC,
