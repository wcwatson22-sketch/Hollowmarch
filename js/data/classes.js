...
export const CLASSES = {
  ...
  hunter: {
    ...
    swingTime: 2.8,
    autoName: 'Auto Shot',
    autoProc: { id: 'autobleed', name: 'Barbed Arrow', type: 'bleed', school: SCHOOL.PHYS,
      coef: 0.20, ticks: 4, tick: 1.8 },
    autoCoef: 0.80,
    dmgMult: 1.051,
    defMult: 1.034,
    ...
    abilities: [
      ...
      { id: 'caltrops', type: 'bleed', name: 'Caltrops', unlock: 6, cd: 11, kind: 'dot', school: SCHOOL.PHYS,
        coef: 0.34, ticks: 5, tick: 1.8, desc: 'Scatters barbs that open the target for 34% AP per tick, 5 ticks.' },
  ...
  warlock: {
    ...
    autoName: 'Wand',
    autoProc: { id: 'autoburn', name: 'Cinder', type: 'fire', school: SCHOOL.MAGIC,
      coef: 0.22, ticks: 4, tick: 1.8 },
    autoCoef: 0.80,
    dmgMult: 0.930,
    defMult: 1.282,
